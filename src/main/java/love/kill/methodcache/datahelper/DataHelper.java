...
public interface DataHelper {
	 ...
	 * @return key
	 * */
	Map<String, Map<String,Object>> getSituation(String match,String select);
	 ...
	 * */
	@SuppressWarnings("unchecked")
	default Map<String, Map<String, Object>> filterSituationModel(Map<String, Map<String, Object>> cacheMap, CacheSituationModel cacheSituationModel, String match, String select) {
		...
		if(!StringUtils.isEmpty(select)){
			String args = cacheSituationModel.getArgs();
			if(!StringUtils.isEmpty(args) && !args.contains(select)){
				return cacheMap;
			}
		}
